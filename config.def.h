...
static Key keys[] = {
	...
	{ 0, XF86XK_AudioRaiseVolume,	spawn,			SHCMD("pamixer --allow-boost -i 3; refbar; pkill -RTMIN+11 dwmblocks &") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,			SHCMD("pamixer --allow-boost -d 3; refbar; pkill -RTMIN+11 dwmblocks &") },

...
static const Rule rules[] = {
	...
	{ "Firefox", 		NULL,     		NULL,           		0,    		0,          	0,      -1,         0,		-1 },
	{ "St",      		NULL,     		NULL,           		0,         	0,          	0,       1,        	0,		-1 },
	{ NULL,      		NULL,     		"Event Tester", 		0,         	0,          	0,       1,        	0,		-1 }, /* xev */
	{ NULL,	      		NULL,       	"khal",     			0,          1,             	1,       1,    		0,		-1 },
	{ NULL,	      		NULL,     		"galculator", 			0,          1,             	1,       0,    		0,		-1 },
	{ "Gnome-calendar", NULL, 			NULL,       			0,          1,             	1,       0,    		0,		-1 },
	{ NULL,       		NULL,     		"Steam - News",	 		0,          1,             	1,       0,    		0,		-1 },
	{ NULL,       		NULL,     		"Friends List",	 		0,          1,             	1,       0,    		0,		-1 },
	{ "Nitrogen", 		NULL, 	  		NULL,       			0,          1,             	1,       0,    		0,		-1 },
	{ "Arandr", 		NULL,       	NULL,         			0,          1,             	1,       0,    		0,		-1 },
	{ NULL,	      		NULL,     		"amixer",     			0,          1,             	1,       0,    		0,		-1 },
...
static Key keys[] = {
	...
	{ MODKEY, 			XK_F9,	   	spawn,	   		SHCMD("autodisplay") },
...
//	{ 0, XF86XK_MonBrightnessDown,	spawn,			SHCMD("xbacklight -dec 5; pkill -RTMIN+12 dwmblocks &") },
	{ 0, XF86XK_MonBrightnessUp,    spawn,          SHCMD("pkill -RTMIN+12 dwmblocks &") },
	{ 0, XF86XK_MonBrightnessDown,  spawn,          SHCMD("pkill -RTMIN+12 dwmblocks &") },
	{ 0, XF86XK_AudioRaiseVolume,	spawn,			SHCMD("pamixer --allow-boost -i 3; pkill -RTMIN+11 dwmblocks &") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,			SHCMD("pamixer --allow-boost -d 3; pkill -RTMIN+11 dwmblocks &") },
	{ 0, XF86XK_AudioMute,			spawn,			SHCMD("pamixer -t; refbar; pkill -RTMIN+11 dwmblocks &") },
	{ 0, XF86XK_AudioMicMute,		spawn,			SHCMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle") },
	{ 0, XF86XK_TouchpadToggle,		spawn,		  	SHCMD("(synclient | grep 'TouchpadOff.*1' && synclient TouchpadOff=0) || synclient TouchpadOff=1") },
	{ 0, XF86XK_Sleep,				spawn,			SHCMD("systemctl suspend") },
	{ 0, XF86XK_ScreenSaver,		spawn,			SHCMD("slock & displayoff") },
